...
// float                                   DynamicIntensity                                       (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
// struct FVector                          ColorChannel                                           (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)

void ABP_TrailsManager_C::RegisterTrail(const struct FVector& Location, float Radius, float Depth, float Hardness, float DynamicIntensity, const struct FVector& ColorChannel)
{
	static class UFunction* Func = nullptr;
	...
	Parms.DynamicIntensity = DynamicIntensity;
	Parms.ColorChannel = std::move(ColorChannel);
