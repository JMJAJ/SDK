...
#include "TargetIsNotMonster_classes.hpp"
#include "TargetIsNotMonster_parameters.hpp"
...
bool UTargetIsNotMonster_C::CanApplyGameplayEffectContent(class AActor* SourceActor, class AActor* TargetActor, class AActor* InstigatorActor, const class UGameplayEffect* GameplayEffect) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("TargetIsNotMonster_C", "CanApplyGameplayEffectContent");

	Params::TargetIsNotMonster_C_CanApplyGameplayEffectContent Parms{};
