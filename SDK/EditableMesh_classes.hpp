...
public:
	...
	uint8                                         Pad_1B08[0x9C];                                    // 0x003C(0x009C)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1B09[0x390];                                   // 0x0028(0x0390)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UEditableMeshAdapter*>           Adapters;                                          // 0x03B8(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_1B0A[0x8];                                     // 0x03C8(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B0B[0x148];                                   // 0x03D4(0x0148)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1B0C[0x1E4];                                   // 0x0524(0x01E4)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_1B32[0xA4];                                    // 0x003C(0x00A4)(Fixing Struct Size After Last Property [ Dumper-7 ])
