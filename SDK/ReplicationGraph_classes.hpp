...
public:
	...
	uint8                                         Pad_EA9[0x40];                                     // 0x0058(0x0040)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EAA[0x3E0];                                    // 0x00B8(0x03E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_EAB[0x8];                                      // 0x04C8(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_EAC[0x18];                                     // 0x0038(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EAD[0xA8];                                     // 0x0050(0x00A8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EAE[0xE8];                                     // 0x0050(0x00E8)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EAF[0x30];                                     // 0x00F8(0x0030)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EB0[0x98];                                     // 0x00F8(0x0098)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EB1[0x10];                                     // 0x00F8(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EB2[0x48];                                     // 0x00F8(0x0048)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EB3[0x1E0];                                    // 0x0050(0x01E0)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_EB4[0x10];                                     // 0x0058(0x0010)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_EB5[0x18];                                     // 0x00F8(0x0018)(Fixing Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_EB6[0x18];                                     // 0x0060(0x0018)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_EB7[0x140];                                    // 0x0030(0x0140)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EB8[0x10];                                     // 0x0178(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FLastLocationGatherInfo>        LastGatherLocations;                               // 0x0188(0x0010)(ZeroConstructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_EB9[0x8];                                      // 0x0198(0x0008)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_EBA[0x80];                                     // 0x01B8(0x0080)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	class UReplicationGraph*                      ReplicationGraph;                                  // 0x0238(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	class UNetReplicationGraphConnection*         ConnectionManager;                                 // 0x0240(0x0008)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
static_assert(sizeof(AReplicationGraphDebugActor) == 0x000248, "Wrong size on AReplicationGraphDebugActor");
static_assert(offsetof(AReplicationGraphDebugActor, ReplicationGraph) == 0x000238, "Member 'AReplicationGraphDebugActor::ReplicationGraph' has a wrong offset!");
static_assert(offsetof(AReplicationGraphDebugActor, ConnectionManager) == 0x000240, "Member 'AReplicationGraphDebugActor::ConnectionManager' has a wrong offset!");
