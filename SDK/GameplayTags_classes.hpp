...
public:
	...
	uint8                                         Pad_5338[0x10];                                    // 0x0038(0x0010)(Fixing Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_5339[0x98];                                    // 0x0028(0x0098)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<struct FGameplayTagSource>             TagSources;                                        // 0x00C0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_533A[0xE0];                                    // 0x00D0(0x00E0)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UDataTable*>                     GameplayTagTables;                                 // 0x01B0(0x0010)(ZeroConstructor, NativeAccessSpecifierPrivate)
	uint8                                         Pad_533B[0x50];                                    // 0x01C0(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
public:
	...
	uint8                                         Pad_533C[0x5];                                     // 0x004B(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
