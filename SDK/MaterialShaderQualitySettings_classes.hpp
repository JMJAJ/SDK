...
{
public:
	struct FMaterialQualityOverrides              QualityOverrides[0x6];                             // 0x0028(0x0009)(Edit, Config, NoDestructor, NativeAccessSpecifierPublic)
	uint8                                         Pad_5194[0x12];                                    // 0x005E(0x0012)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UShaderPlatformQualitySettings) == 0x000070, "Wrong size on UShaderPlatformQualitySettings");
