...
static_assert(alignof(UBTTask_IdleStateReachedGoal_C) == 0x000008, "Wrong alignment on UBTTask_IdleStateReachedGoal_C");
static_assert(sizeof(UBTTask_IdleStateReachedGoal_C) == 0x0000B0, "Wrong size on UBTTask_IdleStateReachedGoal_C");
static_assert(offsetof(UBTTask_IdleStateReachedGoal_C, UberGraphFrame) == 0x0000A8, "Member 'UBTTask_IdleStateReachedGoal_C::UberGraphFrame' has a wrong offset!");
