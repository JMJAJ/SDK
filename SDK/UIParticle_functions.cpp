...
void UUIParticleEmitter::SetParticleRotationStart(float InRotation)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("UIParticleEmitter", "SetParticleRotationStart");

	Params::UIParticleEmitter_SetParticleRotationStart Parms{};
