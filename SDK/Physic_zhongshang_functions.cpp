...
#include "Physic_zhongshang_classes.hpp"
#include "Physic_zhongshang_parameters.hpp"
...
float UPhysic_zhongshang_C::HottaCalculateBaseMagnitude(const class AActor* OwnerActor, const class AActor* HitActor, const class AActor* InstigatorActor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Physic_zhongshang_C", "HottaCalculateBaseMagnitude");

	Params::Physic_zhongshang_C_HottaCalculateBaseMagnitude Parms{};
