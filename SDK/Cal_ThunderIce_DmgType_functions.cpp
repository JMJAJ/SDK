...
#include "Cal_ThunderIce_DmgType_classes.hpp"
#include "Cal_ThunderIce_DmgType_parameters.hpp"
...
float UCal_ThunderIce_DmgType_C::HottaCalculateBaseMagnitude(const class AActor* OwnerActor, const class AActor* HitActor, const class AActor* InstigatorActor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("Cal_ThunderIce_DmgType_C", "HottaCalculateBaseMagnitude");

	Params::Cal_ThunderIce_DmgType_C_HottaCalculateBaseMagnitude Parms{};
