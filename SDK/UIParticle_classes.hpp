...
{
public:
	class UUIParticleAsset*                       Asset;                                             // 0x0128(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             EventOnEnd;                                        // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         bPlayParticle : 1;                                 // 0x0140(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          IsPlaying;                                         // 0x0141(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A7A[0x16];                                    // 0x0142(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UUIParticle) == 0x000158, "Wrong size on UUIParticle");
static_assert(offsetof(UUIParticle, Asset) == 0x000128, "Member 'UUIParticle::Asset' has a wrong offset!");
static_assert(offsetof(UUIParticle, EventOnEnd) == 0x000130, "Member 'UUIParticle::EventOnEnd' has a wrong offset!");
static_assert(offsetof(UUIParticle, IsPlaying) == 0x000141, "Member 'UUIParticle::IsPlaying' has a wrong offset!");
...
{
public:
	class UUIParticleEmitterAsset*                Asset;                                             // 0x0128(0x0008)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             EventOnEnd;                                        // 0x0130(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         bPlayParticle : 1;                                 // 0x0140(0x0001)(BitIndex: 0x00, PropSize: 0x0001 (Edit, BlueprintVisible, BlueprintReadOnly, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic))
	bool                                          IsPlaying;                                         // 0x0141(0x0001)(Edit, BlueprintVisible, BlueprintReadOnly, ZeroConstructor, DisableEditOnTemplate, EditConst, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_1A7B[0x16];                                    // 0x0142(0x0016)(Fixing Struct Size After Last Property [ Dumper-7 ])

public:
	void Play();
	void SetParticleRotationStart(float InRotation);
	void SetPlayParticle(bool InPlayParticle);
	void Stop();
	void StopEmit();
...
static_assert(sizeof(UUIParticleEmitter) == 0x000158, "Wrong size on UUIParticleEmitter");
static_assert(offsetof(UUIParticleEmitter, Asset) == 0x000128, "Member 'UUIParticleEmitter::Asset' has a wrong offset!");
static_assert(offsetof(UUIParticleEmitter, EventOnEnd) == 0x000130, "Member 'UUIParticleEmitter::EventOnEnd' has a wrong offset!");
static_assert(offsetof(UUIParticleEmitter, IsPlaying) == 0x000141, "Member 'UUIParticleEmitter::IsPlaying' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_1A7C[0x3];                                     // 0x0029(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A7D[0x4];                                     // 0x17FC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A7E[0x1];                                     // 0x27D3(0x0001)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A7F[0x3];                                     // 0x27DD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A80[0x6];                                     // 0x575A(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A81[0x6];                                     // 0x9EBA(0x0006)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1A82[0x7];                                     // 0xA6A9(0x0007)(Fixing Size After Last Property [ Dumper-7 ])
