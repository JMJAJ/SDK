...
#include "SelfIsInPK_classes.hpp"
#include "SelfIsInPK_parameters.hpp"
...
bool USelfIsInPK_C::CanApplyGameplayEffectContent(class AActor* SourceActor, class AActor* TargetActor, class AActor* InstigatorActor, const class UGameplayEffect* GameplayEffect) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SelfIsInPK_C", "CanApplyGameplayEffectContent");

	Params::SelfIsInPK_C_CanApplyGameplayEffectContent Parms{};
