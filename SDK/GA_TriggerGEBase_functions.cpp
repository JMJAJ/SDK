...
void UGA_TriggerGEBase_C::ApplyEffect(const struct FGameplayTag& Tag)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_TriggerGEBase_C", "ApplyEffect");

	Params::GA_TriggerGEBase_C_ApplyEffect Parms{};
