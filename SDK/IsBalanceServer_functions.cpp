...
#include "IsBalanceServer_classes.hpp"
#include "IsBalanceServer_parameters.hpp"
...
bool UIsBalanceServer_C::CanApplyGameplayEffectContent(class AActor* SourceActor, class AActor* TargetActor, class AActor* InstigatorActor, const class UGameplayEffect* GameplayEffect) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("IsBalanceServer_C", "CanApplyGameplayEffectContent");

	Params::IsBalanceServer_C_CanApplyGameplayEffectContent Parms{};
