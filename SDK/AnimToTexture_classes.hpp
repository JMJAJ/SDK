...
public:
	...
	uint8                                         Pad_1780[0x4];                                     // 0x005C(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1781[0x5];                                     // 0x00A3(0x0005)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1782[0x4];                                     // 0x01AC(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1783[0x3];                                     // 0x01C1(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1784[0x3];                                     // 0x01CD(0x0003)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1785[0x4];                                     // 0x0214(0x0004)(Fixing Size After Last Property [ Dumper-7 ])
	...
	uint8                                         Pad_1786[0x8];                                     // 0x0228(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAnimToTextureDataAsset) == 0x000230, "Wrong size on UAnimToTextureDataAsset");
...
static_assert(offsetof(UAnimToTextureDataAsset, bAutoPlay) == 0x0001C0, "Member 'UAnimToTextureDataAsset::bAutoPlay' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, AnimationIndex) == 0x0001C4, "Member 'UAnimToTextureDataAsset::AnimationIndex' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, Frame) == 0x0001C8, "Member 'UAnimToTextureDataAsset::Frame' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, NumBoneInfluences) == 0x0001CC, "Member 'UAnimToTextureDataAsset::NumBoneInfluences' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, NumFrames) == 0x0001D0, "Member 'UAnimToTextureDataAsset::NumFrames' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, NumBones) == 0x0001D4, "Member 'UAnimToTextureDataAsset::NumBones' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, VertexRowsPerFrame) == 0x0001D8, "Member 'UAnimToTextureDataAsset::VertexRowsPerFrame' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, VertexMinBBox) == 0x0001DC, "Member 'UAnimToTextureDataAsset::VertexMinBBox' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, VertexSizeBBox) == 0x0001E8, "Member 'UAnimToTextureDataAsset::VertexSizeBBox' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, BoneWeightRowsPerFrame) == 0x0001F4, "Member 'UAnimToTextureDataAsset::BoneWeightRowsPerFrame' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, BoneRowsPerFrame) == 0x0001F8, "Member 'UAnimToTextureDataAsset::BoneRowsPerFrame' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, BoneMinBBox) == 0x0001FC, "Member 'UAnimToTextureDataAsset::BoneMinBBox' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, BoneSizeBBox) == 0x000208, "Member 'UAnimToTextureDataAsset::BoneSizeBBox' has a wrong offset!");
static_assert(offsetof(UAnimToTextureDataAsset, Animations) == 0x000218, "Member 'UAnimToTextureDataAsset::Animations' has a wrong offset!");
