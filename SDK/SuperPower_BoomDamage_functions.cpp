...
#include "SuperPower_BoomDamage_classes.hpp"
#include "SuperPower_BoomDamage_parameters.hpp"
...
float USuperPower_BoomDamage_C::HottaCalculateBaseMagnitude(const class AActor* OwnerActor, const class AActor* HitActor, const class AActor* InstigatorActor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("SuperPower_BoomDamage_C", "HottaCalculateBaseMagnitude");

	Params::SuperPower_BoomDamage_C_HottaCalculateBaseMagnitude Parms{};
