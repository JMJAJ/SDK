...
#include "AsukaATFieldLimitMult_classes.hpp"
#include "AsukaATFieldLimitMult_parameters.hpp"
...
float UAsukaATFieldLimitMult_C::HottaCalculateBaseMagnitude(const class AActor* OwnerActor, const class AActor* HitActor, const class AActor* InstigatorActor) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("AsukaATFieldLimitMult_C", "HottaCalculateBaseMagnitude");

	Params::AsukaATFieldLimitMult_C_HottaCalculateBaseMagnitude Parms{};
