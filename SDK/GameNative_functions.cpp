...
bool UINTLGameNativeAPI::WhetherDeviceIsAvailable()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = StaticClass()->GetFunction("INTLGameNativeAPI", "WhetherDeviceIsAvailable");

	Params::INTLGameNativeAPI_WhetherDeviceIsAvailable Parms{};
