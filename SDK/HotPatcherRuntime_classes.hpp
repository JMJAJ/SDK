...
public:
	...
	static bool OpenPSO(const class FString& Param_Name);
...
public:
	...
	static bool LoadShaderPipelineCache(const class FString& Param_Name);
...
public:
	static class UClass* StaticClass()
	{
		return StaticClassImpl<"HotPatcherAssetManager">();
	}
...
static_assert(alignof(UHotPatcherAssetManager) == 0x000008, "Wrong alignment on UHotPatcherAssetManager");
static_assert(sizeof(UHotPatcherAssetManager) == 0x000458, "Wrong size on UHotPatcherAssetManager");
...
{
public:
	FMulticastInlineDelegateProperty_             OnMountPakDelegate;                                // 0x0028(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	FMulticastInlineDelegateProperty_             OnUnMountPakDelegate;                              // 0x0038(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
	uint8                                         Pad_1906[0x50];                                    // 0x0048(0x0050)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
{
public:
	uint8                                         Pad_1907[0x8];                                     // 0x0028(0x0008)(Fixing Struct Size After Last Property [ Dumper-7 ])
