...
#include "IsNotBalanceServer_classes.hpp"
#include "IsNotBalanceServer_parameters.hpp"
...
bool UIsNotBalanceServer_C::CanApplyGameplayEffectContent(class AActor* SourceActor, class AActor* TargetActor, class AActor* InstigatorActor, const class UGameplayEffect* GameplayEffect) const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("IsNotBalanceServer_C", "CanApplyGameplayEffectContent");

	Params::IsNotBalanceServer_C_CanApplyGameplayEffectContent Parms{};
